...
## agrio.system::cfgproducer    account config
...
## agrio.system::okproducer     account producer vote
...
## agrio.system::setproxy       account proxy
...
## agrio.system::unstake        account quantity 
...
## agrio.system::withdraw account
   - this action can only be triggered by agrio.system via a deferred transaction generated by unstake
   - this will generate an inline agrio.token::transfer call from=agrio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## agrio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## agrio.system::stakevote account amount
   - the primary currency of agrio is controlled by the token contract which enables users to transfer
...
## agrio.system::onblock   account blocktime blocknum
...
## agrio.system::freeze producer accounts true|false 
...
## agrio.system::paystandby producer
